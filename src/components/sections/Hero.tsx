...
export default function Hero() {
  return (
    <section className="relative min-h-[88vh] flex items-center overflow-hidden bg-white pt-36 pb-24 border-b border-black/[0.06]">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(#0A0A0A_1px,transparent_1px)] [background-size:24px_24px] opacity-[0.035] pointer-events-none" />

      {/* Atmospheric Soft Red Glow */}
      <div className="absolute top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,_rgba(232,0,29,0.07)_0%,_transparent_70%)] rounded-full blur-[80px] pointer-events-none" />
      <div className="absolute bottom-10 right-1/4 w-[500px] h-[500px] bg-[radial-gradient(circle,_rgba(232,0,29,0.05)_0%,_transparent_70%)] rounded-full blur-[90px] pointer-events-none" />

      {/* Giant Ghost Number */}
      <div className="absolute right-8 top-32 select-none pointer-events-none font-mono font-black tracking-tighter text-black/[0.022] text-[18rem] leading-none">
        01
      </div>
